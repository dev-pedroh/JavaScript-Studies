...
btn.onclick = function(){
    //Declara a variável de texto que será adcionado ao paraágrafo
    let textElement = '';
    ...
    //Verifica se o usuario preencheu o input, caso contrário coloca um texto padrão
    if(inputValue !== ""){
    ...
    //Recupera a div
    let divElement = document.querySelector('#app'); // # usa-se para ID
